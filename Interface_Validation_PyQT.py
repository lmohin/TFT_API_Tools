...
#Main Window
class PreviewQt(QWidget):
    def __init__(self, case, lst):
        
        self.app = QApplication(sys.argv)
        self.app2 = QMainWindow()
        self.Widget2 = QWidget()
        
        self.button1 = QPushButton("Validate")
        self.button1.clicked.connect(self.Write_cells_call)
        
        self.button2 = QPushButton("Cancel")
        self.button2.clicked.connect(self.DestroyAll)
        ...
        self.Widget2.setLayout(self.box)
        #self.app2.setCentralWidget(self.Widget2)
        #Show window
        self.show()
        self.Widget2.show()
    ...
    def createTable(self):
        ...
        #Row count
        self.tableWidget.setRowCount(self.total_rows) 

        #Column count
        self.tableWidget.setColumnCount(self.total_columns)  

        for i in range(self.total_rows):
            for j in range(self.total_columns):
                
                self.tableWidget.setItem(i,j, QTableWidgetItem(self.lst[i][j]))
    ...
    def on_change(self,i,j):
        ...
        new_value = self.tableWidget.item(i,j).text()
...
if __name__ == '__main__':
    ...
    ex = PreviewQt("Liste Joueurs!D3", liste)
